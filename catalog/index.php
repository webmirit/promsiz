...
$APPLICATION->SetPageProperty("description", "Каталог продукции из стекла ГХСЗ Гусь-Хрустальный Стекольный Завод (ООО ПромСИЗ). Подробнее!");
$APPLICATION->SetPageProperty("keywords", "ГХСЗ Гусь-Хрустальный Стекольный Завод (ООО ПромСИЗ): каталог продукции из стекла");
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_PROPERTY_CODE" => array(
			0 => "KOLICHESTVO_PREDMETOV_V_NABORE",
			1 => "TSVET",
			2 => "KOLVO_V_UPAKOVKE",
			3 => "KOLICHESTVO_V_NABORE_GLADYA_1",
			4 => "OBYEM_GOFROUPAKOVKI_M3",
			5 => "VYSOTA_H_MM",
			6 => "DIAMETR",
			7 => "TIP_UPAKOVKI",
			8 => "KATEGORIYA",
		...
		"SHOW_ARTICLE_SKU" => "Y",
		"SORT_REGION_PRICE" => "КрОПТ-Предоплата (дог)",
