...
<div class="item normal_block">
	<div class="item_inner">
		...
		<?endif;?>
		<div class="scale_block_animate img_block" style="background-image:url('<?=($arItem["DETAIL_PICTURE"]["SRC"] ? $arItem["DETAIL_PICTURE"]["SRC"] : $arItem["PREVIEW_PICTURE"]["SRC"])?>.webp')"></div>
	</div>
</div>