							...
							<div class="img shine">
								<div class="img_inner">
									<?if($sUrl):?>
										<a href="<?=$sUrl;?>">
									<?endif;?>
									<img src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>.webp" alt="<?=($arItem['PREVIEW_PICTURE']['ALT']?$arItem['PREVIEW_PICTURE']['ALT']:$arItem['NAME']);?>" title="<?=($arItem['PREVIEW_PICTURE']['TITLE']?$arItem['PREVIEW_PICTURE']['TITLE']:$arItem['NAME']);?>" />
									<?if($sUrl):?>
										</a>
									<?endif;?>
								</div>
