...
<head>
	...
	<?
		if (preg_match('/PAGEN/',$cur_page))
		{
            $new_page=substr($cur_page,0,strripos($cur_page,'?'));
        }
	?><script data-ad-client="ca-pub-2354472562823288" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
