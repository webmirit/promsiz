					...
					<div class="top-block-item col-md-4">
						<div class="phone-block">
							<?if($bPhone):?>
                                ...
                                <div style="position: absolute;right: -650px;top: -10px;"> <div id="ytWidget"></div><script src="https://translate.yandex.net/website-widget/v1/widget.js?widgetId=ytWidget&pageLang=ru&widgetTheme=light&autoMode=false" type="text/javascript"></script>
                                </div>
							<?endif?>
